...
Route::group([
    ...
    Route::group([
        ...
        /**Record */
        Route::resource('record','Api\Record\RecordController',['except'=>['destroy']])->middleware('permission:record.update');
        Route::resource('record','Api\Record\RecordController',['only'=>['destroy']])->middleware('permission:record.delete');
        /**Rooms Record */
